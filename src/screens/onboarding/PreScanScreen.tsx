...
function BreathingIcon() {
  // Three stacked "air" waves — a simple, recognizable breathing glyph.
  return (
    <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
      <Path
        d="M3 7.5C5 5.5 7 5.5 9 7.5C11 9.5 13 9.5 15 7.5C16.5 6 18.5 6 20.5 7.5"
        stroke={ICON}
        strokeWidth={1.6}
        strokeLinecap="round"
      />
      <Path
        d="M3 12C5 10 7 10 9 12C11 14 13 14 15 12C16.5 10.5 18.5 10.5 20.5 12"
        stroke={ICON}
        strokeWidth={1.6}
        strokeLinecap="round"
      />
      <Path
        d="M3 16.5C5 14.5 7 14.5 9 16.5C11 18.5 13 18.5 15 16.5C16.5 15 18.5 15 20.5 16.5"
        stroke={ICON}
        strokeWidth={1.6}
        strokeLinecap="round"
      />
